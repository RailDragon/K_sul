...
import 'recommend_page11_model.dart';
export 'recommend_page11_model.dart';

class RecommendPage11Widget extends StatefulWidget {
  const RecommendPage11Widget({super.key});

  static String routeName = 'RecommendPage1-1';
  static String routePath = '/recommendPage11';

  @override
  State<RecommendPage11Widget> createState() => _RecommendPage11WidgetState();
}

class _RecommendPage11WidgetState extends State<RecommendPage11Widget> {
  late RecommendPage11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecommendPage11Model());
  }
            ...
            children: [
              ...
              Container(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(
                      RecommendPage12Widget.routeName,
