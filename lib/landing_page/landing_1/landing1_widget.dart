...
class Landing1Widget extends StatefulWidget {
  ...
  static String routeName = 'Landing-1';
  static String routePath = '/landing1';
                                ...
                                children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          ...
                                          image: Image.asset(
                                            'assets/images/DALLE_2025-04-14_15.31.22_-_A_cute_animal_character_scene_for_a_K-Sool_(Korean_alcohol)_mobile_app._A_cartoon_animal_(such_as_a_dog_or_bear)_wearing_Korean_traditional_clothing_(.webp',
                                          ).image,
                                        ),
                                        borderRadius: BorderRadius.only(
                                          bottomLeft: Radius.circular(0.0),
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          '카메라로 찍기만 해도 전통주 애호가들의 리뷰,\n다양한 지역의 정통주 정보까지 검색이 가능해요',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                ...
                                children: [
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          ...
                                          alignment:
                                              AlignmentDirectional(0.0, 0.0),
                                          image: Image.asset(
                                            'assets/images/DALLE_2025-04-14_15.30.11_-_A_cute_scene_for_a_K-Sool_(Korean_alcohol)_mobile_app._Two_cartoon_dog_characters_dressed_in_Korean_traditional_clothing_(hanbok_and_gat)_are_interact.webp',
                                          ).image,
                                        ),
                                        borderRadius: BorderRadius.only(
                                          bottomLeft: Radius.circular(0.0),
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          '내가 마신 전통주를 간단하게 기록하고\n많은 사람의 별점을 살펴볼 수 있어요',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                        ...
                        Align(
                          ...
                          child: smooth_page_indicator.SmoothPageIndicator(
                            ...
                            effect: smooth_page_indicator.ExpandingDotsEffect(
                              ...
                              activeDotColor: Color(0xFFFF8216),
